...
import dietplanner.db.DatabaseConnection;  //connect to DB
import dietplanner.model.Meal;
import java.sql.*;        //import all classes to work with databases i.e., SQL
import java.util.ArrayList;
import java.util.List;    //store list of meals
